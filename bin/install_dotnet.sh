...
# Per documentation found here: https://learn.microsoft.com/en-us/dotnet/core/install/linux-scripted-manual#scripted-install
# This is the script downloaded from here: https://dot.net/v1/dotnet-install.sh
