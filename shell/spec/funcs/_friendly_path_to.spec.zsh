...
script_under_test="../../funcs/_friendly_path_to"
Describe "funcs/_friendly_path_to"
    ...
    Context "defines"
        ...
        Describe "function '_friendly_path_to', which"
            It "exists"
                When call type "_friendly_path_to"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function '_friendly_path_to'""
