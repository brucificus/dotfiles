...
script_under_test="../../funcs/phook_push_funcname"
Describe "funcs/phook_push_funcname"
    ...
    Context "defines"
        ...
        Describe "function 'phook_push_funcname', which"
            It "exists"
                When call type "phook_push_funcname"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'phook_push_funcname'""
