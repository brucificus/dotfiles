...
script_under_test="../../funcs/_phook_enqueue"
Describe "funcs/_phook_enqueue"
    ...
    Context "defines"
        ...
        Describe "function '_phook_enqueue', which"
            It "exists"
                When call type "_phook_enqueue"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function '_phook_enqueue'""
