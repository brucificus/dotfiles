...
script_under_test="../../funcs/mk_shellspec"
Describe "funcs/mk_shellspec"
    ...
    Context "defines"
        ...
        Describe "function 'mk_shellspec', which"
            It "exists"
                When call type "mk_shellspec"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'mk_shellspec'""
