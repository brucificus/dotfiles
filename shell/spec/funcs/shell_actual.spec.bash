...
script_under_test="../../funcs/shell_actual"
Describe "funcs/shell_actual"
    ...
    Context "defines"
        ...
        Describe "function 'shell_actual', which"
            It "exists"
                When call type "shell_actual"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'shell_actual'""
