...
script_under_test="../../funcs/completion_exists"
Describe "funcs/completion_exists"
    ...
    Context "defines"
        ...
        Describe "function 'completion_exists', which"
            It "exists"
                When call type "completion_exists"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'completion_exists'""
