...
script_under_test="../../funcs/_syspip3_package_location"
Describe "funcs/_syspip3_package_location"
    ...
    Context "defines"
        ...
        Describe "function '_syspip3_package_location', which"
            It "exists"
                When call type "_syspip3_package_location"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function '_syspip3_package_location'""
