...
script_under_test="../../funcs/builtins_ls"
Describe "funcs/builtins_ls"
    ...
    Context "defines"
        ...
        Describe "function 'builtins_ls', which"
            It "exists"
                When call type "builtins_ls"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'builtins_ls'""
