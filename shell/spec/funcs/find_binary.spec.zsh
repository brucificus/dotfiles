...
script_under_test="../../funcs/find_binary"
Describe "funcs/find_binary"
    ...
    Context "defines"
        ...
        Describe "function 'find_binary', which"
            It "exists"
                When call type "find_binary"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'find_binary'""
