...
script_under_test="../../funcs/binary_exists"
Describe "funcs/binary_exists"
    ...
    Context "defines"
        ...
        Describe "function 'binary_exists', which"
            It "exists"
                When call type "binary_exists"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'binary_exists'""
