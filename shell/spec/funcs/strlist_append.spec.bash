...
script_under_test="../../funcs/strlist_append"
Describe "funcs/strlist_append"
    ...
    Context "defines"
        ...
        Describe "function 'strlist_append', which"
            It "exists"
                When call type "strlist_append"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'strlist_append'""
