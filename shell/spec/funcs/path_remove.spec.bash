...
script_under_test="../../funcs/path_remove"
Describe "funcs/path_remove"
    ...
    Context "defines"
        ...
        Describe "function 'path_remove', which"
            It "exists"
                When call type "path_remove"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'path_remove'""
