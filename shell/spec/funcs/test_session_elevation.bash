...
script_under_test="../../funcs/test_session_elevation"
Describe "funcs/test_session_elevation"
    ...
    Context "defines"
        ...
        Describe "function 'test_session_elevation', which"
            It "exists"
                When call type "test_session_elevation"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'test_session_elevation'""
