...
script_under_test="../../funcs/phook_enqueue_file_optional"
Describe "funcs/phook_enqueue_file_optional"
    ...
    Context "defines"
        ...
        Describe "function 'phook_enqueue_file_optional', which"
            It "exists"
                When call type "phook_enqueue_file_optional"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'phook_enqueue_file_optional'""
