...
script_under_test="../../funcs/_phook_push"
Describe "funcs/_phook_push"
    ...
    Context "defines"
        ...
        Describe "function '_phook_push', which"
            It "exists"
                When call type "_phook_push"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function '_phook_push'""
