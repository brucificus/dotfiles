...
script_under_test="../../funcs/append_profile_suggestions"
Describe "funcs/append_profile_suggestions"
    ...
    Context "defines"
        ...
        Describe "function 'append_profile_suggestions', which"
            It "exists"
                When call type "append_profile_suggestions"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'append_profile_suggestions'""
