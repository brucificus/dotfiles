...
script_under_test="../../funcs/_try_cd_quietly"
Describe "funcs/_try_cd_quietly"
    ...
    Context "defines"
        ...
        Describe "function '_try_cd_quietly', which"
            It "exists"
                When call type "_try_cd_quietly"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function '_try_cd_quietly'""
