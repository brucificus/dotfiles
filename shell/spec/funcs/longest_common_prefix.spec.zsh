...
script_under_test="../../funcs/longest_common_prefix"
Describe "funcs/longest_common_prefix"
    ...
    Context "defines"
        ...
        Describe "function 'longest_common_prefix', which"
            It "exists"
                When call type "longest_common_prefix"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'longest_common_prefix'""
