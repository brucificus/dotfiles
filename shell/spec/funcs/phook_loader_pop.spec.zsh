...
script_under_test="../../funcs/phook_loader_pop"
Describe "funcs/phook_loader_pop"
    ...
    Context "defines"
        ...
        Describe "function 'phook_loader_pop', which"
            It "exists"
                When call type "phook_loader_pop"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'phook_loader_pop'""
