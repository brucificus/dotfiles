...
script_under_test="../../funcs/test_session_interactivity"
Describe "funcs/test_session_interactivity"
    ...
    Context "defines"
        ...
        Describe "function 'test_session_interactivity', which"
            It "exists"
                When call type "test_session_interactivity"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'test_session_interactivity'""
