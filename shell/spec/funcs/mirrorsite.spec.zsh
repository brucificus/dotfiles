...
script_under_test="../../funcs/mirrorsite"
Describe "funcs/mirrorsite"
    ...
    Context "defines"
        ...
        Describe "function 'mirrorsite', which"
            It "exists"
                When call type "mirrorsite"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'mirrorsite'""
