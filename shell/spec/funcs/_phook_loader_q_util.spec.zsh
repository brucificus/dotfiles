...
script_under_test="../../funcs/._phook_loader_q_util.sh"
Describe "funcs/._phook_loader_q_util.sh"
    ...
    Context "when sourced"
        ...
        It "succeeds"
            phook_caller='abc'; export phook_caller
            phook_mode='def'; export phook_mode
            phook_dir="$ScriptUnderTestDir/.."; export phook_dir
