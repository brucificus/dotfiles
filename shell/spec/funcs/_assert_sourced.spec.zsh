...
script_under_test="../../funcs/_assert_sourced"
Describe "funcs/_assert_sourced"
    ...
    Context "defines"
        ...
        Describe "function '_assert_sourced', which"
            It "exists"
                When call type "_assert_sourced"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function '_assert_sourced'""
