...
script_under_test="../../funcs/path_prepend"
Describe "funcs/path_prepend"
    ...
    Context "defines"
        ...
        Describe "function 'path_prepend', which"
            It "exists"
                When call type "path_prepend"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'path_prepend'""
