...
script_under_test="../../funcs/path_append"
Describe "funcs/path_append"
    ...
    Context "defines"
        ...
        Describe "function 'path_append', which"
            It "exists"
                When call type "path_append"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'path_append'""
