...
script_under_test="../../funcs/path_removematch"
Describe "funcs/path_removematch"
    ...
    Context "defines"
        ...
        Describe "function 'path_removematch', which"
            It "exists"
                When call type "path_removematch"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'path_removematch'""
