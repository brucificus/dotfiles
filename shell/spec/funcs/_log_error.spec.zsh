...
script_under_test="../../funcs/_log_error"
Describe "funcs/_log_error"
    ...
    Context "defines"
        ...
        Describe "function '_log_error', which"
            It "exists"
                When call type "_log_error"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function '_log_error'""
