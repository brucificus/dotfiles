...
script_under_test="../../funcs/load_ohmyposh_theme"
Describe "funcs/load_ohmyposh_theme"
    ...
    Context "defines"
        ...
        Describe "function 'load_ohmyposh_theme', which"
            It "exists"
                When call type "load_ohmyposh_theme"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'load_ohmyposh_theme'""
