...
script_under_test="../../funcs/naive_shell_replace"
Describe "funcs/naive_shell_replace"
    ...
    Context "defines"
        ...
        Describe "function 'naive_shell_replace', which"
            It "exists"
                When call type "naive_shell_replace"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'naive_shell_replace'""
