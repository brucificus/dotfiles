...
script_under_test="../../funcs/dotfiles_update"
Describe "funcs/dotfiles_update"
    ...
    Context "defines"
        ...
        Describe "function 'dotfiles_update', which"
            It "exists"
                When call type "dotfiles_update"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'dotfiles_update'""
