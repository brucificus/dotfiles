...
script_under_test="../../funcs/echo_shellspec_spec_content"
Describe "funcs/echo_shellspec_spec_content"
    ...
    Context "defines"
        ...
        Describe "function 'echo_shellspec_spec_content', which"
            It "exists"
                When call type "echo_shellspec_spec_content"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'echo_shellspec_spec_content'""
