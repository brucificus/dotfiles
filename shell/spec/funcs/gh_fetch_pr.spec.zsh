...
script_under_test="../../funcs/gh_fetch_pr"
Describe "funcs/gh_fetch_pr"
    ...
    Context "defines"
        ...
        Describe "function 'gh_fetch_pr', which"
            It "exists"
                When call type "gh_fetch_pr"

                The status should be success
                The output should include "$1 is a shell function"
            End
        End # Describe "function 'gh_fetch_pr'""
