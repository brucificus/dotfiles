...
script_under_test="../../funcs/find_autojump"
Describe "funcs/find_autojump"
    ...
    Context "defines"
        ...
        Describe "function 'find_autojump', which"
            It "exists"
                When call type "find_autojump"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function 'find_autojump'""
