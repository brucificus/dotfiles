...
script_under_test="../../funcs/._bashit_load_core.bash"
Describe "funcs/._bashit_load_core.bash"
    ...
    function cd_into_ScriptUnderTestDir() {
        ...
        source "$ScriptUnderTestDir/_log_info"
        source "$ScriptUnderTestDir/_assert_sourced"
        source "$ScriptUnderTestDir/_concatenate_paths"
    }
