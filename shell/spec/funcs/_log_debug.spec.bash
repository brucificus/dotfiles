...
script_under_test="../../funcs/_log_debug"
Describe "funcs/_log_debug"
    ...
    Context "defines"
        ...
        Describe "function '_log_debug', which"
            It "exists"
                When call type "_log_debug"

                The status should be success
                The output should include "$1 is a function"
            End
        End # Describe "function '_log_debug'""
