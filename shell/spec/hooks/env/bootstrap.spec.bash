...
script_under_test="../../../hooks/env/bootstrap.bash"
Describe "hooks/env/bootstrap.bash"
    ...
    function cd_into_ScriptUnderTestDir() {
        ...
        Include "$ScriptUnderTestDir/../../funcs/path_sep"
        Include "$ScriptUnderTestDir/../../funcs/find_binary"
        Include "$ScriptUnderTestDir/../../funcs/path_remove"
        Include "$ScriptUnderTestDir/../../funcs/path_prepend"
        Include "$ScriptUnderTestDir/../../funcs/path_removematch"
