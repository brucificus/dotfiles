...
script_under_test="../../../hooks/rc/session.bash"
Describe "hooks/rc/session.bash"
    ...
    function cd_into_ScriptUnderTestDir() {
        ...
        Include "$ScriptUnderTestDir/../../funcs/binary_exists"
        Include "$ScriptUnderTestDir/../../funcs/command_exists"
        _command_exists() { command_exists "$@"; } # Mock out _command_exists.
