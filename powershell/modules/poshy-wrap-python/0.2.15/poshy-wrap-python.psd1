#
# Module manifest for module 'poshy-wrap-python'
#
...
RootModule = './src/poshy-wrap-python.psm1'
...
GUID = '259945bf-df2c-4fed-8b15-caedf79fc736'
...
Description = 'Convenient cmdlets and aliases which wrap `python3`.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'poshy-wrap', 'poshy-wrap-python', 'PSCommand__python3', 
               'PSCommand_ipy', 'PSCommand_ipython', 'PSCommand_py', 
               'PSCommand_pyserver', 'PSCommand_python', 'PSCommand_python3', 
               'PSCommand_shttp', 'PSEdition_Core', 'PSEdition_Desktop', 
               'PSFunction__python3', 'PSFunction_pyserver', 'PSFunction_shttp', 
               'PSIncludes_Command', 'PSIncludes_Function', 'PSModule', 'pwshrc', 
               'python', 'python3'

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/pwshrc/poshy-wrap-python/tree/4aa39ff6c719ce06617aa92a41d3d11c053745b5/LICENSE.txt'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/pwshrc/poshy-wrap-python'
