...
NestedModules = @('./lib/poshy-lucidity.0.3.15/poshy-lucidity.psd1')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/pwshrc/poshy-env-var/tree/ae0c393bf068ea43274a5ba9e521fd669f67d2bb/LICENSE.txt'
...
- ⬆️ Bump pwshrc/actions-determine-version from 0.8.6 to 0.8.7 (#36)
   - PR: #0'
