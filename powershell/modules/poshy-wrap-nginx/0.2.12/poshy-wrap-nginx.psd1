#
# Module manifest for module 'poshy-wrap-nginx'
#
...
RootModule = './src/poshy-wrap-nginx.psm1'
...
GUID = 'a82141a3-446e-4e1c-a931-820e8e386e21'
...
Description = 'Convenient cmdlets and aliases which wrap `nginx`.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'nginx', 'poshy-wrap', 'poshy-wrap-nginx', 'PSCommand_nginx_reload', 
               'PSCommand_nginx_restart', 'PSCommand_nginx_start', 
               'PSCommand_nginx_stop', 'PSEdition_Core', 'PSEdition_Desktop', 
               'PSFunction_nginx_reload', 'PSFunction_nginx_restart', 
               'PSFunction_nginx_start', 'PSFunction_nginx_stop', 
               'PSIncludes_Command', 'PSIncludes_Function', 'PSModule', 'pwshrc'

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/pwshrc/poshy-wrap-nginx/tree/d50b0fd7b37a14903a89fc8842652b7c2190a5f7/LICENSE.txt'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/pwshrc/poshy-wrap-nginx'
