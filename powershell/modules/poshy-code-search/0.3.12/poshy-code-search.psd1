#
# Module manifest for module 'poshy-code-search'
#
...
RootModule = './src/poshy-code-search.psm1'
...
GUID = 'b14c8536-5aa6-499d-a1ba-021821ac77c9'
...
Description = 'Convenient cmdlets for text searches against source code files.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'egrep', 'grep', 'poshy-code-search', 
               'PSCommand_Get-PwshAliasDefinition', 
               'PSCommand_Get-PwshFunctionDefinition', 'PSCommand_Search-Ruby', 
               'PSEdition_Core', 'PSEdition_Desktop', 
               'PSFunction_Get-PwshAliasDefinition', 
               'PSFunction_Get-PwshFunctionDefinition', 'PSFunction_Search-Ruby', 
               'PSIncludes_Command', 'PSIncludes_Function', 'PSModule', 'pwshrc', 
               'search'

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/pwshrc/poshy-code-search/tree/bed4b421eaa03c6850610397fe5521d6362f6b1a/LICENSE.txt'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/pwshrc/poshy-code-search'
