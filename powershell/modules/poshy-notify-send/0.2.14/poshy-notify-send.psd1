...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'BurntToast', 'GrowlNotify', 'kdialog', 'notifu', 'notify-send', 
               'notify-send-wsl', 'poshy-notify-send', 
               'PSCommand_notify-send-fallback', 'PSEdition_Core', 
               'PSEdition_Desktop', 'PSFunction_notify-send-fallback', 
               'PSIncludes_Command', 'PSIncludes_Function', 'PSModule', 'pwshrc', 
               'terminal', 'TerminalNotifier', 'toast'

        # A URL to the license for this module.
        LicenseUri = 'https://github.com/pwshrc/poshy-notify-send/tree/c7e59141f85ef2adb82fcdbab7a857fbb6287605/LICENSE.txt'
